...
public extension Currency {
    ...
    init?(iso code: CurrencyCode) {
        ...
        case 0x0000045100000000: self = .aed   // AED
        case 0x0000046380000000: self = .afn   // AFN
        case 0x000004C300000000: self = .all   // ALL
        case 0x000004D100000000: self = .amd   // AMD
        case 0x000004F040000000: self = .aoa   // AOA
        case 0x00000524C0000000: self = .ars   // ARS
        case 0x0000055100000000: self = .aud   // AUD
        case 0x00000571C0000000: self = .awg   // AWG
        case 0x000005A380000000: self = .azn   // AZN
        case 0x0000081340000000: self = .bam   // BAM
        case 0x0000082100000000: self = .bbd   // BBD
        case 0x0000084500000000: self = .bdt   // BDT
        case 0x0000088100000000: self = .bhd   // BHD
        case 0x0000089180000000: self = .bif   // BIF
        case 0x000008D100000000: self = .bmd   // BMD
        case 0x000008E100000000: self = .bnd   // BND
        case 0x000008F080000000: self = .bob   // BOB
        case 0x000008F580000000: self = .bov   // BOV
        case 0x0000092300000000: self = .brl   // BRL
        case 0x0000093100000000: self = .bsd   // BSD
        case 0x0000094380000000: self = .btn   // BTN
        case 0x0000097400000000: self = .bwp   // BWP
        case 0x0000099380000000: self = .byn   // BYN
        case 0x000009A100000000: self = .bzd   // BZD
        case 0x00000C1100000000: self = .cad   // CAD
        case 0x00000C4180000000: self = .cdf   // CDF
        case 0x00000C8140000000: self = .che   // CHE
        case 0x00000C8180000000: self = .chf   // CHF
        case 0x00000C85C0000000: self = .chw   // CHW
        case 0x00000CC180000000: self = .clf   // CLF
        case 0x00000CC400000000: self = .clp   // CLP
        case 0x00000CE640000000: self = .cny   // CNY
        case 0x00000CF400000000: self = .cop   // COP
        case 0x00000CF540000000: self = .cou   // COU
        case 0x00000D20C0000000: self = .crc   // CRC
        case 0x00000D5400000000: self = .cup   // CUP
        case 0x00000D6140000000: self = .cve   // CVE
        case 0x00000DA2C0000000: self = .czk   // CZK
        case 0x000010A180000000: self = .djf   // DJF
        case 0x000010B2C0000000: self = .dkk   // DKK
        case 0x000010F400000000: self = .dop   // DOP
        case 0x000011A100000000: self = .dzd   // DZD
        case 0x0000147400000000: self = .egp   // EGP
        case 0x0000152380000000: self = .ern   // ERN
        case 0x0000154080000000: self = .etb   // ETB
        case 0x0000155480000000: self = .eur   // EUR
        case 0x000018A100000000: self = .fjd   // FJD
        case 0x000018B400000000: self = .fkp   // FKP
        case 0x00001C2400000000: self = .gbp   // GBP
        case 0x00001C5300000000: self = .gel   // GEL
        case 0x00001C84C0000000: self = .ghs   // GHS
        case 0x00001C9400000000: self = .gip   // GIP
        case 0x00001CD100000000: self = .gmd   // GMD
        case 0x00001CE180000000: self = .gnf   // GNF
        case 0x00001D4440000000: self = .gtq   // GTQ
        case 0x00001D9100000000: self = .gyd   // GYD
        case 0x000020B100000000: self = .hkd   // HKD
        case 0x000020E300000000: self = .hnl   // HNL
        case 0x00002141C0000000: self = .htg   // HTG
        case 0x0000215180000000: self = .huf   // HUF
        case 0x0000244480000000: self = .idr   // IDR
        case 0x000024C4C0000000: self = .ils   // ILS
        case 0x000024E480000000: self = .inr   // INR
        case 0x0000251100000000: self = .iqd   // IQD
        case 0x0000252480000000: self = .irr   // IRR
        case 0x00002532C0000000: self = .isk   // ISK
        case 0x000028D100000000: self = .jmd   // JMD
        case 0x000028F100000000: self = .jod   // JOD
        case 0x0000290640000000: self = .jpy   // JPY
        case 0x00002C54C0000000: self = .kes   // KES
        case 0x00002C74C0000000: self = .kgs   // KGS
        case 0x00002C8480000000: self = .khr   // KHR
        case 0x00002CD180000000: self = .kmf   // KMF
        case 0x00002D05C0000000: self = .kpw   // KPW
        case 0x00002D25C0000000: self = .krw   // KRW
        case 0x00002D7100000000: self = .kwd   // KWD
        case 0x00002D9100000000: self = .kyd   // KYD
        case 0x00002DA500000000: self = .kzt   // KZT
        case 0x00003012C0000000: self = .lak   // LAK
        case 0x0000302400000000: self = .lbp   // LBP
        case 0x000030B480000000: self = .lkr   // LKR
        case 0x0000312100000000: self = .lrd   // LRD
        case 0x0000313300000000: self = .lsl   // LSL
        case 0x0000319100000000: self = .lyd   // LYD
        case 0x0000341100000000: self = .mad   // MAD
        case 0x0000344300000000: self = .mdl   // MDL
        case 0x0000347040000000: self = .mga   // MGA
        case 0x000034B100000000: self = .mkd   // MKD
        case 0x000034D2C0000000: self = .mmk   // MMK
        case 0x000034E500000000: self = .mnt   // MNT
        case 0x000034F400000000: self = .mop   // MOP
        case 0x0000352540000000: self = .mru   // MRU
        case 0x0000355480000000: self = .mur   // MUR
        case 0x0000356480000000: self = .mvr   // MVR
        case 0x00003572C0000000: self = .mwk   // MWK
        case 0x0000358380000000: self = .mxn   // MXN
        case 0x0000358580000000: self = .mxv   // MXV
        case 0x0000359480000000: self = .myr   // MYR
        case 0x000035A380000000: self = .mzn   // MZN
        case 0x0000381100000000: self = .nad   // NAD
        case 0x0000387380000000: self = .ngn   // NGN
        case 0x00003893C0000000: self = .nio   // NIO
        case 0x000038F2C0000000: self = .nok   // NOK
        case 0x0000390480000000: self = .npr   // NPR
        case 0x000039A100000000: self = .nzd   // NZD
        case 0x00003CD480000000: self = .omr   // OMR
        case 0x0000401080000000: self = .pab   // PAB
        case 0x0000405380000000: self = .pen   // PEN
        case 0x00004072C0000000: self = .pgk   // PGK
        case 0x0000408400000000: self = .php   // PHP
        case 0x000040B480000000: self = .pkr   // PKR
        case 0x000040C380000000: self = .pln   // PLN
        case 0x00004191C0000000: self = .pyg   // PYG
        case 0x0000441480000000: self = .qar   // QAR
        case 0x000048F380000000: self = .ron   // RON
        case 0x0000493100000000: self = .rsd   // RSD
        case 0x0000495080000000: self = .rub   // RUB
        case 0x0000497180000000: self = .rwf   // RWF
        case 0x00004C1480000000: self = .sar   // SAR
        case 0x00004C2100000000: self = .sbd   // SBD
        case 0x00004C3480000000: self = .scr   // SCR
        case 0x00004C41C0000000: self = .sdg   // SDG
        case 0x00004C52C0000000: self = .sek   // SEK
        case 0x00004C7100000000: self = .sgd   // SGD
        case 0x00004C8400000000: self = .shp   // SHP
        case 0x00004CC140000000: self = .sle   // SLE
        case 0x00004CF4C0000000: self = .sos   // SOS
        case 0x00004D2100000000: self = .srd   // SRD
        case 0x00004D3400000000: self = .ssp   // SSP
        case 0x00004D4380000000: self = .stn   // STN
        case 0x00004D60C0000000: self = .svc   // SVC
        case 0x00004D9400000000: self = .syp   // SYP
        case 0x00004DA300000000: self = .szl   // SZL
        case 0x0000508080000000: self = .thb   // THB
        case 0x000050A4C0000000: self = .tjs   // TJS
        case 0x000050D500000000: self = .tmt   // TMT
        case 0x000050E100000000: self = .tnd   // TND
        case 0x000050F400000000: self = .top   // TOP
        case 0x0000512640000000: self = .`try`   // TRY
        case 0x0000514100000000: self = .ttd   // TTD
        case 0x0000517100000000: self = .twd   // TWD
        case 0x000051A4C0000000: self = .tzs   // TZS
        case 0x0000541200000000: self = .uah   // UAH
        case 0x0000547600000000: self = .ugx   // UGX
        case 0x0000553100000000: self = .usd   // USD
        case 0x0000553380000000: self = .usn   // USN
        case 0x0000559240000000: self = .uyi   // UYI
        case 0x0000559540000000: self = .uyu   // UYU
        case 0x00005595C0000000: self = .uyw   // UYW
        case 0x000055A4C0000000: self = .uzs   // UZS
        case 0x0000585100000000: self = .ved   // VED
        case 0x00005854C0000000: self = .ves   // VES
        case 0x000058E100000000: self = .vnd   // VND
        case 0x0000595580000000: self = .vuv   // VUV
        case 0x00005D3500000000: self = .wst   // WST
        case 0x0000601100000000: self = .xad   // XAD
        case 0x0000601180000000: self = .xaf   // XAF
        case 0x0000603100000000: self = .xcd   // XCD
        case 0x00006031C0000000: self = .xcg   // XCG
        case 0x000060F180000000: self = .xof   // XOF
        case 0x0000610180000000: self = .xpf   // XPF
        case 0x0000645480000000: self = .yer   // YER
        case 0x0000681480000000: self = .zar   // ZAR
        case 0x000068D5C0000000: self = .zmw   // ZMW
        case 0x00006971C0000000: self = .zwg   // ZWG
        default: return nil
        }
    }
}
