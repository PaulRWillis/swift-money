...
struct FullNameLayout {
    let other: MoneyFormatAffixes
    let byCategory: [PluralCategory: MoneyFormatAffixes]

    init(other: MoneyFormatAffixes, byCategory: [PluralCategory: MoneyFormatAffixes] = [:]) {
        self.other = other
