...
public struct ExchangeRate<From: Currency, To: Currency>: Sendable {
    ...
    // TODO: Rename to `ExchangeRate.convert(_ amount: Money<From>, rounding: FloatingPointRoundingRule = .toNearestOrAwayFromZero)
    ...
    public func conversionResult(
        ...
        let amount = Money<To>(minorUnits: multiplication.amount.minorUnits)
