...
| Scale and round | 21 ns | 1 ns | 3 ns | 3901 ns (83 allocs) |
| Comparison | 2 ns | 2 ns | 2 ns | 127 ns (4 allocs) |
| Split into 3 | 7 ns | 3 ns | 3 ns | 1965 ns (37 allocs) |
| Chained scaling | 106 ns | 2 ns | 4 ns | 2189 ns (41 allocs) |
...
| Split, iterating the parts | 373 ns |
| Total of 10 | 5 ns |
...
| Time (wall clock) (ns) * |       557 |       557 |       557 |       558 |       558 |       558 |       558 |         2 |
...
| Time (wall clock) (ns) * |       383 |       383 |       383 |       384 |       384 |       384 |       384 |         3 |
...
| Time (wall clock) (ns) * |       740 |       740 |       740 |       745 |       745 |       745 |       745 |         2 |
...
| Time (wall clock) (ns) * |       634 |       635 |       635 |       639 |       639 |       639 |       639 |         2 |
...
| Time (wall clock) (ns) * |      1855 |      1855 |      1855 |      1855 |      1855 |      1855 |      1855 |         1 |
...
| Time (wall clock) (ns) * |      2015 |      2015 |      2015 |      2015 |      2015 |      2015 |      2015 |         1 |
...
| Time (wall clock) (ns) * |       222 |       222 |       222 |       222 |       222 |       222 |       222 |         5 |
...
|:-------------------------|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|
| Malloc (total) *         |         5 |         5 |         5 |         5 |         5 |         5 |         5 |         5 |
| Time (wall clock) (ns) * |       212 |       212 |       212 |       213 |       214 |       214 |       214 |         5 |
...
| Time (wall clock) (ns) * |      3901 |      3901 |      3901 |      3901 |      3901 |      3901 |      3901 |         1 |
...
| Time (wall clock) (ns) * |       290 |       290 |       290 |       292 |       292 |       292 |       292 |         4 |
...
| Time (wall clock) (ns) * |        43 |        43 |        43 |        43 |        44 |        45 |        45 |        23 |
...
| Time (wall clock) (ns) * |      4060 |      4060 |      4060 |      4060 |      4060 |      4060 |      4060 |         1 |
...
| Time (wall clock) (ns) * |      2110 |      2110 |      2110 |      2110 |      2110 |      2110 |      2110 |         1 |
...
| Time (wall clock) (ns) * |       322 |       323 |       323 |       323 |       324 |       324 |       324 |         4 |
...
| Time (wall clock) (ns) * |       826 |       826 |       826 |       827 |       827 |       827 |       827 |         2 |
...
| Time (wall clock) (ns) * |       164 |       165 |       165 |       166 |       169 |       169 |       169 |         7 |
...
| Time (wall clock) (ns) * |        82 |        83 |        84 |        84 |        84 |        84 |        84 |        12 |
...
| Time (wall clock) (ns) * |      3152 |      3152 |      3152 |      3152 |      3152 |      3152 |      3152 |         1 |
...
|:-------------------------|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|
| Malloc (total) *         |        11 |        11 |        11 |        11 |        11 |        11 |        11 |         2 |
| Time (wall clock) (ns) * |       828 |       828 |       828 |       844 |       844 |       844 |       844 |         2 |
...
| Time (wall clock) (ns) * |        17 |        17 |        17 |        18 |        18 |        19 |        19 |        57 |
...
|:-------------------------|----------:|----------:|----------:|----------:|----------:|----------:|----------:|----------:|
| Malloc (total) *         |         4 |         4 |         4 |         4 |         4 |         4 |         4 |         7 |
| Time (wall clock) (ns) * |       161 |       163 |       164 |       164 |       165 |       165 |       165 |         7 |
...
| Time (wall clock) (ns) * |       373 |       373 |       373 |       373 |       373 |       373 |       373 |         3 |
...
| Time (wall clock) (ns) * |         5 |         5 |         5 |         6 |         6 |         7 |         7 |       180 |
