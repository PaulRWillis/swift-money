...
struct MoneyCurrencyTests {
    ...
    func caseDoesNotSplitACurrency() throws {
        let lower = Money(minorUnits: 5, currency: Currency(code: "gbp", minimalQuantization: 100))
        let upper = Money(minorUnits: 7, currency: Currency(code: "GBP", minimalQuantization: 100))
